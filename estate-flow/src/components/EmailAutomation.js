    ...
    <div className="email-automation-overlay" onClick={onClose}>
      <div className="email-automation-modal" onClick={e => e.stopPropagation()}>
        <div className="email-automation-header">
          <h2><MdEmail style={{ marginRight: '8px' }} />Email Automation</h2>
            ...
            <div className="feature-list">
              ...
              <div className="feature-item">
                ...
                <div>
                  ...
                  <p>Send automatic rent reminder emails to tenants before due dates</p>
                </div>
              </div>
              <div className="feature-item">
                ...
                <div>
                  ...
                  <p>Automated notifications for maintenance requests and updates</p>
                </div>
              </div>
            </div>
          </div>
